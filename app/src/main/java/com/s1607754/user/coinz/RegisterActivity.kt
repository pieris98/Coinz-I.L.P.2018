    ...
    private fun newRegister() {
        ...
        fAuth.createUserWithEmailAndPassword(email, password)
                .addOnCompleteListener {
                    ...
                    val user = FireUser(fAuth.uid ?: "", email, HashMap(), HashMap(),HashMap(),HashMap(), HashMap(),HashMap(),false,false,0.0)
